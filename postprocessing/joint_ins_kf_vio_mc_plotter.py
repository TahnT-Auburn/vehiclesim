...
def joint_ins_kf_vio_mc_plotter(
    ...
    theo_std: NDArray,
    x_mc_vio: NDArray,
    x_error_mc_vio: NDArray,
    x_mc_mean_vio: NDArray,
    ...
    # === extract statistics for vio ====
    # extract raw monte carlo states and errors
    N_mc_vio = x_mc_vio[0].transpose()
    E_mc_vio = x_mc_vio[1].transpose()
    yaw_mc_vio = x_mc_vio[2].transpose()
    hitch_mc_vio = x_mc_vio[3].transpose()
    vy_mc_vio = x_mc_vio[4].transpose()
    yaw_rate_mc_vio = x_mc_vio[5].transpose()
    hitch_rate_mc_vio = x_mc_vio[6].transpose()
    
    N_error_mc_vio = x_error_mc_vio[0].transpose()
    E_error_mc_vio = x_error_mc_vio[1].transpose()
    yaw_error_mc_vio = x_error_mc_vio[2].transpose()
    hitch_error_mc_vio = x_error_mc_vio[3].transpose()
    vy_error_mc_vio = x_error_mc_vio[4].transpose()
    yaw_rate_error_mc_vio = x_error_mc_vio[5].transpose()
    hitch_rate_error_mc_vio = x_error_mc_vio[6].transpose()
    
    # extract means/stds for each state and state error
    # state means
    N_mean_vio = x_mc_mean_vio[0]
    E_mean_vio = x_mc_mean_vio[1]
    yaw_mean_vio = x_mc_mean_vio[2]
    hitch_mean_vio = x_mc_mean_vio[3]
    vy_mean_vio = x_mc_mean_vio[4]
    yaw_rate_mean_vio = x_mc_mean_vio[5]
    hitch_rate_mean_vio = x_mc_mean_vio[6]
    
    # state mc stds
    N_std_vio = x_mc_std_vio[0]
    E_std_vio = x_mc_std_vio[1]
    yaw_std_vio = x_mc_std_vio[2]
    hitch_std_vio = x_mc_std_vio[3]
    vy_std_vio = x_mc_std_vio[4]
    yaw_rate_std_vio = x_mc_std_vio[5]
    hitch_rate_std_vio = x_mc_std_vio[6]
    
    # state error means
    N_error_mean_vio = x_error_mc_mean_vio[0]
    E_error_mean_vio = x_error_mc_mean_vio[1]
    yaw_error_mean_vio = x_error_mc_mean_vio[2]
    hitch_error_mean_vio = x_error_mc_mean_vio[3]
    vy_error_mean_vio = x_error_mc_mean_vio[4]
    yaw_rate_error_mean_vio = x_error_mc_mean_vio[5]
    hitch_rate_error_mean_vio = x_error_mc_mean_vio[6]
    
    # state error stds
    N_error_std_vio = x_error_mc_std_vio[0]
    E_error_std_vio = x_error_mc_std_vio[1]
    yaw_error_std_vio = x_error_mc_std_vio[2]
    hitch_error_std_vio = x_error_mc_std_vio[3]
    vy_error_std_vio = x_error_mc_std_vio[4]
    ...
    plt.plot(t, N_error_mean_vio + sigma_bound_fator * N_error_std_vio, color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
    plt.plot(t, N_error_mean_vio - sigma_bound_fator * N_error_std_vio, color='cyan')
    plt.legend()
    # plt.title('North Position Error')
    plt.xlabel('Time [s]')
    plt.ylabel('North Position Error [m]')
    plt.show()
    ...
    plt.plot(t, E_error_mean_vio + sigma_bound_fator * E_error_std_vio, color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
    plt.plot(t, E_error_mean_vio - sigma_bound_fator * E_error_std_vio, color='cyan')
    plt.legend()
    ...
    plt.plot(t, vx_error_mean + sigma_bound_fator * vx_error_std, 'r', label='EKF exp $\pm$'+str(sigma_bound_fator)+'$\sigma$')
    # plt.plot(t, 0 + sigma_bound_fator * vx_theo_std, '--k', label='EKF theo $\pm$'+str(sigma_bound_fator)+'$\sigma$')
    ...
    plt.plot(t, vy_error_mc_vio, linewidth=1, alpha=0.4, color='#021D30')
    plt.plot(t, vy_error_mean + sigma_bound_fator * vy_error_std, 'r', label='EKF exp $\pm$'+str(sigma_bound_fator)+'$\sigma$')
    # plt.plot(t, 0 + sigma_bound_fator * vy_theo_std, '--k', label='EKF theo $\pm$'+str(sigma_bound_fator)+'$\sigma$')
    plt.plot(t, vy_error_mean - sigma_bound_fator * vy_error_std, 'r')
    # plt.plot(t, 0 - sigma_bound_fator * vy_theo_std, '--k')
    plt.plot(t, vy_error_mean_vio + sigma_bound_fator * vy_error_std_vio, color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
    plt.plot(t, vy_error_mean_vio - sigma_bound_fator * vy_error_std_vio, color='cyan')
    plt.legend()
    ...
    plt.plot(t, np.rad2deg(yaw_rate_error_mc_vio), linewidth=1, alpha=0.4, color="#021D30")
    plt.plot(t, np.rad2deg(yaw_rate_error_mean + sigma_bound_fator * yaw_rate_error_std), 'r', label='EKF exp $\pm$'+str(sigma_bound_fator)+'$\sigma$')
    # plt.plot(t, np.rad2deg(0 + sigma_bound_fator * yaw_rate_theo_std), '--k', label='EKF theo $\pm$'+str(sigma_bound_fator)+'$\sigma$')
    ...
    plt.plot(t, np.rad2deg(yaw_rate_error_mean_vio + sigma_bound_fator * yaw_rate_error_std_vio), color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
    plt.plot(t, np.rad2deg(yaw_rate_error_mean_vio - sigma_bound_fator * yaw_rate_error_std_vio), color='cyan')
    plt.legend()
    ...
    plt.plot(t, np.rad2deg(yaw_error_mean_vio + sigma_bound_fator * yaw_error_std_vio), color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
    plt.plot(t, np.rad2deg(yaw_error_mean_vio - sigma_bound_fator * yaw_error_std_vio), color='cyan')
    plt.legend()
    # plt.title('Yaw Error')
    plt.xlabel('Time [s]')
    ...
    plt.plot(t, np.rad2deg(hitch_rate_error_mc_vio), linewidth=1, alpha=0.4, color="#021D30")
    plt.plot(t, np.rad2deg(hitch_rate_error_mean + sigma_bound_fator * hitch_rate_error_std), 'r', label='EKF exp $\pm$'+str(sigma_bound_fator)+'$\sigma$')
    # plt.plot(t, np.rad2deg(0 + sigma_bound_fator * hitch_rate_theo_std), '--k', label='EKF theo $\pm$'+str(sigma_bound_fator)+'$\sigma$')
    ...
    plt.plot(t, np.rad2deg(hitch_rate_error_mean_vio + sigma_bound_fator * hitch_rate_error_std_vio), color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
    plt.plot(t, np.rad2deg(hitch_rate_error_mean_vio - sigma_bound_fator * hitch_rate_error_std_vio), color='cyan')
    plt.legend()
    ...
    plt.plot(t, np.rad2deg(hitch_error_mc_vio), linewidth=1, alpha=0.4, color='#021D30')
    plt.plot(t, np.rad2deg(hitch_error_mean + sigma_bound_fator * hitch_error_std), 'r', label='EKF exp $\pm$'+str(sigma_bound_fator)+'$\sigma$')
    # plt.plot(t, np.rad2deg(0 + sigma_bound_fator * hitch_theo_std), '--k', label='EKF theo $\pm$'+str(sigma_bound_fator)+'$\sigma$')
    ...
    plt.plot(t, np.rad2deg(hitch_error_mean_vio + sigma_bound_fator * hitch_error_std_vio), color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
    plt.plot(t, np.rad2deg(hitch_error_mean_vio - sigma_bound_fator * hitch_error_std_vio), color='cyan')
    plt.legend()
    ...
    if not error_only:
        ...
        plt.plot(t, N_mean_vio + sigma_bound_fator * N_std_vio, color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
        plt.plot(t, N_mean_vio - sigma_bound_fator * N_std_vio, color='cyan')
        plt.legend()
        ...
        plt.plot(t, E_mean_vio + sigma_bound_fator * E_std_vio, color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
        plt.plot(t, E_mean_vio - sigma_bound_fator * E_std_vio, color='cyan')
        plt.legend()
        ...
        plt.plot(t, vx_mean + sigma_bound_fator * vx_std, 'r', label='EKF exp $\pm$'+str(sigma_bound_fator)+'$\sigma$')
        # plt.plot(t, vx_mean + sigma_bound_fator * vx_theo_std, '--k', label='EKF theo $\pm$'+str(sigma_bound_fator)+'$\sigma$')
        ...
        plt.plot(t, vy_mc_vio, linewidth=1, alpha=0.4, color="#021D30")
        plt.plot(t, vy_mean + sigma_bound_fator * vy_std, 'r', label='EKF exp $\pm$'+str(sigma_bound_fator)+'$\sigma$')
        # plt.plot(t, vy_mean + sigma_bound_fator * vy_theo_std, '--k', label='EKF theo $\pm$'+str(sigma_bound_fator)+'$\sigma$')
        plt.plot(t, vy_mean - sigma_bound_fator * vy_std, 'r')
        # plt.plot(t, vy_mean - sigma_bound_fator * vy_theo_std, '--k')
        plt.plot(t, vy_mean_vio + sigma_bound_fator * vy_std_vio, color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
        plt.plot(t, vy_mean_vio - sigma_bound_fator * vy_std_vio, color='cyan')
        plt.legend()
        ...
        plt.plot(t, np.rad2deg(yaw_rate_mc_vio), linewidth=1, alpha=0.4, color="#021D30")
        plt.plot(t, np.rad2deg(yaw_rate_mean + sigma_bound_fator * yaw_rate_std), 'r', label='EKF exp $\pm$'+str(sigma_bound_fator)+'$\sigma$')
        # plt.plot(t, np.rad2deg(yaw_rate_mean + sigma_bound_fator * yaw_rate_theo_std), '--k', label='EKF theo $\pm$'+str(sigma_bound_fator)+'$\sigma$')
        ...
        plt.plot(t, np.rad2deg(yaw_rate_mean_vio + sigma_bound_fator * yaw_rate_std_vio), color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
        plt.plot(t, np.rad2deg(yaw_rate_mean_vio - sigma_bound_fator * yaw_rate_std_vio), color='cyan')
        plt.legend()
        # plt.title('Yaw Rate')
        plt.xlabel('Time [s]')
        ...
        plt.plot(t, np.rad2deg(yaw_mean_vio + sigma_bound_fator * yaw_std_vio), color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
        plt.plot(t, np.rad2deg(yaw_mean_vio - sigma_bound_fator * yaw_std_vio), color='cyan')
        plt.legend()
        # plt.title('Yaw')
        plt.xlabel('Time [s]')
        plt.ylabel('Yaw [deg]')
        ...
        plt.plot(t, np.rad2deg(hitch_rate_mc_vio), linewidth=1, alpha=0.4, color="#021D30")
        plt.plot(t, np.rad2deg(hitch_rate_mean + sigma_bound_fator * hitch_rate_std), 'r', label='EKF exp $\pm$'+str(sigma_bound_fator)+'$\sigma$')
        # plt.plot(t, np.rad2deg(hitch_rate_mean + sigma_bound_fator * hitch_rate_theo_std), '--k', label='EKF theo $\pm$'+str(sigma_bound_fator)+'$\sigma$')
        ...
        plt.plot(t, np.rad2deg(hitch_rate_mean_vio + sigma_bound_fator * hitch_rate_std_vio), color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
        plt.plot(t, np.rad2deg(hitch_rate_mean_vio - sigma_bound_fator * hitch_rate_std_vio), color='cyan')
        plt.legend()
        ...
        plt.plot(t, np.rad2deg(hitch_mc_vio), linewidth=1, alpha=0.4, color="#021D30")
        plt.plot(t, np.rad2deg(hitch_mean + sigma_bound_fator * hitch_std), 'r', label='EKF exp $\pm$'+str(sigma_bound_fator)+'$\sigma$')
        # plt.plot(t, np.rad2deg(hitch_mean + sigma_bound_fator * hitch_theo_std), '--k', label='EKF theo $\pm$'+str(sigma_bound_fator)+'$\sigma$')
        ...
        plt.plot(t, np.rad2deg(hitch_mean_vio + sigma_bound_fator * hitch_std_vio), color='cyan', label='VIO exp $\pm$'+ str(sigma_bound_fator)+'$\sigma$')
        plt.plot(t, np.rad2deg(hitch_mean_vio - sigma_bound_fator * hitch_std_vio), color='cyan')
        plt.legend()
        # plt.title('Hitch')
        plt.xlabel('Time [s]')
